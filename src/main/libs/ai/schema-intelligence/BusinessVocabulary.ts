...
export const DEFAULT_ABBREVIATIONS: Record<string, string> = {
   cust: 'customer', custs: 'customers', clnt: 'client',
   inv: 'invoice', invc: 'invoice', bill: 'invoice',
   ord: 'order', ordr: 'order', so: 'sales order', po: 'purchase order',
   pmt: 'payment', pay: 'payment', pymt: 'payment',
   prod: 'product', prd: 'product', itm: 'item', sku: 'product',
   qty: 'quantity', amt: 'amount', bal: 'balance', tot: 'total',
   addr: 'address', dept: 'department', emp: 'employee', empl: 'employee',
   usr: 'user', acct: 'account', org: 'organization', loc: 'location',
   cat: 'category', desc: 'description', ref: 'reference', txn: 'transaction',
   trx: 'transaction', hdr: 'header', dtl: 'detail', det: 'detail',
   mst: 'master', mstr: 'master', mstd: 'master data', cfg: 'config',
   whse: 'warehouse', wh: 'warehouse', shp: 'shipment', dlvr: 'delivery',
   num: 'number', no: 'number', dt: 'date', dte: 'date', ts: 'timestamp',
   fk: '', pk: '', id: 'id'
};
