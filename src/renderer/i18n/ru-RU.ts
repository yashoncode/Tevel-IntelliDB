export const ruRU = {
   ...
   application: {
      ...
      restartToInstall: 'Перезапустить Tevel IntelliDB для установки',
      ...
      exportDataExplanation:
            'Экспорт сохранённых соединений в Tevel IntelliDB. Вам будет предложено ввести пароль для шифрования экспортируемого файла.',
      importData: 'Импорт данных',
      importDataExplanation: 'Импортирует файл .Tevel IntelliDB, содержащий соединения. Вам нужно будет ввести пароль, заданный во время экспорта.',
