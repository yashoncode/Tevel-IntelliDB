export const ukUA = {
   ...
   application: { // Терміни, пов'язані з додатком
      ...
      restartToInstall: 'Перезапустіть Tevel IntelliDB, щоб встановити',
      ...
      exportDataExplanation: 'Експорт збережених підключень до Tevel IntelliDB. Вам буде запропоновано ввести пароль для шифрування експортованого файлу.',
      importData: 'Імпорт даних',
      importDataExplanation: 'Імпорт файлу .Tevel IntelliDB, який містить підключення. Вам потрібно буде ввести пароль, встановлений під час експорту.',
