export const uzUZ = {
   ...
   application: {
      ...
      restartToInstall: 'Oʻrnatish uchun Tevel IntelliDB-ni qayta ishga tushiring',
      ...
      exportDataExplanation: 'Tevel IntelliDB-dagi saqlangan ulanishlarni eksport qilish. Shifrlangan fayl uchun parol kiritishingiz soʻraladi.',
      importData: 'Maʼlumotlarni import qilish',
      importDataExplanation: '.Tevel IntelliDB faylini import qiladi, unda ulanishlar mavjud. Eksport paytida kiritilgan parolni kiritishingiz kerak.',
