export const zhCN = {
   ...
   application: { // 应用程序相关术语
      ...
      restartToInstall: '重启 Tevel IntelliDB 以进行安装',
      ...
      exportData: '导出数据',
      exportDataExplanation: '将保存的连接导出到 Tevel IntelliDB. 系统将要求您输入密码以加密导出的文件.',
      importData: '导入数据',
      importDataExplanation: '导入包含连接的 .Tevel IntelliDB 文件. 您需要输入在导出过程中定义的密码.',
