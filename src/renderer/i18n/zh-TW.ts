export const zhTW = {
   ...
   application: {
      ...
      restartToInstall: '重啟 Tevel IntelliDB 以進行安裝',
      ...
      exportData: '導出數據',
      exportDataExplanation: '將保存的連接導出到 Tevel IntelliDB. 係統將要求您輸入密碼以加密導出的檔案.',
      importData: '導入數據',
      importDataExplanation: '導入包含連接的 .Tevel IntelliDB 檔案. 您需要輸入在導出過程中定義的密碼.',
